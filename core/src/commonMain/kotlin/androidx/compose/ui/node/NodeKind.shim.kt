...
internal object Nodes {
	...
	val Layout = NodeKind<LayoutModifierNode>(0b0000_0000_0010)
	val Draw = NodeKind<DrawModifierNode>(0b0000_0000_0100)
	val Locals = NodeKind<androidx.compose.ui.modifier.ModifierLocalModifierNode>(0b0000_0000_1000)
	val BeyondBoundsLayout = NodeKind<androidx.compose.ui.layout.BeyondBoundsLayoutProviderModifierNode>(0b0000_0001_0000)
